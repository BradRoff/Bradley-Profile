...
?>
    <table >
      ...
      <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" onSubmit="return validate(this)">
        <tr><td>Username</td>
          <td><input type="text" maxlength="16" name="username" value="<?php echo $username; ?>">
          ...
          <td><input type="password" maxlength="12" name="password2" value="<?php echo $password2; ?>">
        </td></tr><tr><td>Email</td>
          <td><input type="text" maxlength="64" name="email" value="<?php echo $email; ?>">
        </td></tr><tr><td ><input type="submit" value="Signup"></td></tr>
      </form>
    </table>
  </body>
</html>
